========================================================================
    KONSOLENANWENDUNG: RocketLauncherDriver-Projektübersicht
========================================================================

Diese RocketLauncherDriver-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre RocketLauncherDriver-Anwendung besteht.


RocketLauncherDriver.vcxproj
...
RocketLauncherDriver.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen RocketLauncherDriver.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
